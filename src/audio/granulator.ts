...
export const RUNTIME_DIAG_F_REL_TIME_SEC = 0;
export const RUNTIME_DIAG_F_ACTIVE_VOICES = 1;
export const RUNTIME_DIAG_F_FADING_VOICES = 2;
export const RUNTIME_DIAG_F_PITCH_LOAD = 3;
export const RUNTIME_DIAG_F_INTERP_MODE = 4;
export const RUNTIME_DIAG_F_SAMPLES_UNTIL_NEXT_SPAWN = 5;
export const RUNTIME_DIAG_F_NEXT_VOICE_ID = 6;
export const RUNTIME_DIAG_F_SPAWN_COUNT = 7;
export const RUNTIME_DIAG_F_STEAL_COUNT = 8;
export const RUNTIME_DIAG_F_NORM_GAIN = 9;
export const RUNTIME_DIAG_F_DENSITY = 10;
export const RUNTIME_DIAG_F_VOICE_COUNT = 11;
export const RUNTIME_DIAG_F_MEAN_SAMPLES_PER_GRAIN = 12;
export const RUNTIME_DIAG_F_REQUESTED_QUALITY = 13;
export const RUNTIME_DIAG_F_EFFECTIVE_QUALITY = 14;
export const RUNTIME_DIAG_F_BUDGET_LIMITED = 15;
export const RUNTIME_DIAG_F_ADAPTIVE_QUALITY = 16;
