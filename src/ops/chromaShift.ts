// chromaShift — RGB spatial offset (video) + L/R micro-delay (audio).
//
...
//
// Audio analogue: a small per-channel delay creates inter-channel decorrelation
// that's the temporal analogue of inter-channel spatial offset in the visual
// domain. The `amount` parameter drives both, scaled into each domain's
// natural unit (UV fraction vs milliseconds).
