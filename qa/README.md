...
- `qa/e2e/glyph-pack-programs.spec.ts` recalls the six Advanced typographic / time-domain programs, checks their three-macro surfaces and low-rate audio-band feed, and holds each authored stack to a local ≥30 fps median floor.
