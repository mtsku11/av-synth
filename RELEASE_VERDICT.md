...
| Public preset bank limited to 8–12 programs | PASS | 9 curated programs led by `Singularity Bloom`, `Fracture Relay`, and `Magnetic Cathedral`; remaining programs are Advanced experiments |
...
| Typographic / time-domain pack browser validation | PASS | `glyph-pack-programs.spec.ts`, registry compilation, and slit-scan probes pass locally in headless Chrome |
| Local 8-second showcase recorder proof | PASS | Refreshed 2026-05-31: 9 non-empty VP9/Opus WebM exports generated under `qa/results/showcase-captures/`; `asciiGhostDelay` low-entropy export flagged for hosted review |
