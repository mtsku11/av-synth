...
class ModulateScrollYProcessor extends AudioWorkletProcessor {
  ...
  process(inputs, outputs, parameters) {
    ...
    for (let i = 0; i < outL.length; i++) {
      ...
      const modPan = clamp(mono * amount, -1, 1);
...
registerProcessor('modulate-scrolly', ModulateScrollYProcessor);
