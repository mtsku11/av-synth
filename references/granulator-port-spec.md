...
- No `SharedArrayBuffer` for grain events in v1 — copy-by-message is cheap at our event rates and removes a security/cross-origin-isolation footgun. Reconsider only if scheduler jitter becomes audible.
